<div class="app-header header-shadow">
            ...
            <div class="app-header__content">
                ...
                <div class="input-holder">
                            <p><b><a style="text-decoration:none;" href="<?php echo base_url(); ?>">Bells Dashboard</a></b></p>
                        </div>
                </div>
                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a href="<?php echo base_url(); ?>user/logout" tabindex="0" class="dropdown-item">Logout</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="widget-content-left  ml-3 header-user-info">
                                    <div class="widget-heading">
                                    <?php echo  $this->session->userdata('surname'). ' ' .$this->session->userdata('firstname'); ?>
                                    </div>
